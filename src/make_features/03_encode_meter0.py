...
class target_encoding_by_building_id_folds1_meter0(Feature):
...
class target_encoding_by_site_id_folds1_meter0(Feature):
    def create_features(self):
...
class target_encoding_by_primary_use_folds1_meter0(Feature):
    def create_features(self):
...
class target_encoding_by_building_id_folds2_log_meter0(Feature):
    def create_features(self):
...
class target_encoding_by_site_id_folds2_log_meter0(Feature):
    def create_features(self):
...
class target_encoding_by_primary_use_folds2_log_meter0(Feature):
    def create_features(self):
...
class target_encoding_last_month_meter0(Feature):
    def create_features(self):
...
if __name__ == '__main__':
    ...
    folds1 = pd.read_feather('../folds/01_kfold_meter0.feather')
    folds2 = pd.read_feather('../folds/02_gkfold_meter0.feather')
