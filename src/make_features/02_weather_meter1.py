...
class air_temperature_meter1(Feature):
...
class diff_min_air_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_air_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].min().reset_index()
...
class diff_max_air_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_air_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_std_air_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_air_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_mean_air_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_air_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class cloud_coverage_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_cloud_coverage_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_cloud_coverage_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_max_cloud_coverage_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_cloud_coverage_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_std_cloud_coverage_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_cloud_coverage_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_mean_cloud_coverage_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_cloud_coverage_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class dew_temperature_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_dew_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_dew_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_max_dew_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_dew_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_std_dew_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_dew_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_mean_dew_temperature_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_dew_temperature_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class precip_depth_1_hr_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_precip_depth_1_hr_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_precip_depth_1_hr_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_max_precip_depth_1_hr_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_precip_depth_1_hr_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_std_precip_depth_1_hr_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_precip_depth_1_hr_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_mean_precip_depth_1_hr_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_precip_depth_1_hr_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class sea_level_pressure_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_sea_level_pressure_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_sea_level_pressure_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_max_sea_level_pressure_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_sea_level_pressure_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_std_sea_level_pressure_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_sea_level_pressure_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_mean_sea_level_pressure_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_sea_level_pressure_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class wind_direction_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_wind_direction_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_wind_direction_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_max_wind_direction_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_wind_direction_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_std_wind_direction_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_wind_direction_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_mean_wind_direction_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_wind_direction_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class wind_speed_meter1(Feature):
    def create_features(self):
        aggs = {'min', 'max', 'std', 'mean'}
        rename = {agg: agg + '_' + self.__class__.__name__ for agg in aggs}
...
class diff_min_wind_speed_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_min_wind_speed_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].min().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_max_wind_speed_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_max_wind_speed_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].max().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_std_wind_speed_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_std_wind_speed_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].std().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_mean_wind_speed_from_pre_1d_meter1(Feature):
    def create_features(self):
...
class diff_mean_wind_speed_from_pre_7d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].mean().reset_index()
        df_groupby['date_pre_7d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=7))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_min_air_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_max_air_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_std_air_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_mean_air_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['air_temperature'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'air_temperature']]
...
class diff_min_cloud_coverage_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_max_cloud_coverage_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_std_cloud_coverage_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_mean_cloud_coverage_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['cloud_coverage'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'cloud_coverage']]
...
class diff_min_dew_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_max_dew_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_std_dew_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_mean_dew_temperature_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['dew_temperature'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'dew_temperature']]
...
class diff_min_precip_depth_1_hr_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_max_precip_depth_1_hr_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_std_precip_depth_1_hr_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_mean_precip_depth_1_hr_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['precip_depth_1_hr'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'precip_depth_1_hr']]
...
class diff_min_sea_level_pressure_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_max_sea_level_pressure_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_std_sea_level_pressure_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_mean_sea_level_pressure_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['sea_level_pressure'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'sea_level_pressure']]
...
class diff_min_wind_direction_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_max_wind_direction_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_std_wind_direction_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_mean_wind_direction_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_direction'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_direction']]
...
class diff_min_wind_speed_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].min().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_max_wind_speed_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].max().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_std_wind_speed_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].std().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
...
class diff_mean_wind_speed_from_pre_m1d_meter1(Feature):
    def create_features(self):
        df_groupby = weather.groupby(['site_id', 'date'])['wind_speed'].mean().reset_index()
        df_groupby['date_pre_1d'] = (pd.to_datetime(df_groupby['date']).apply(lambda x: x + datetime.timedelta(days=-1))).astype(str)
        df_groupby1 = df_groupby[['site_id', 'date', 'wind_speed']]
